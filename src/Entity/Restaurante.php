 ...
 */
class Restaurante implements PasswordAuthenticatedUserInterface, UserInterface, \Serializable

{

    public function getUserIdentifier(): string
    {
        return $this->getCorreo(); // O lo que sea que quieras usar como identificador único
    }
